...
export class InventoryController {
  ...
  @Get('movements')
  getMovements(@Headers('x-tenant-id') tid: string, @Query('productId') pid?: string) { return this.svc.getMovements(tid, pid); }

  @Get(':productId')
  findOne(@Headers('x-tenant-id') tid: string, @Param('productId') pid: string) { return this.svc.findOne(tid, pid); }
